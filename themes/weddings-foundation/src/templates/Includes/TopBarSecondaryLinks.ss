<ul class="right">
	<li class="social-icon"><a href="https://www.instagram.com/weddingsatiowa/" target="_blank">
			<img src="{$ThemeDir}/dist/images/instagram-link.png" alt="Instagram" />
		</a>
	</li>
	<li class="social-icon"><a href="https://www.pinterest.com/weddingsatiowa/" target="_blank">
			<img src="{$ThemeDir}/dist/images/pinterest-link.png" alt="Instagram" />
		</a>
	</li>
	<li><a href="http://www.uiowa.edu" title="The University of Iowa" id="wordmark-link" class="uiowa--bar--wordmark uiowa--bar--wordmark--uiowa">
    <svg aria-labelledby="uiowa-wordmark" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72.8 21.4" id="wordmark">
